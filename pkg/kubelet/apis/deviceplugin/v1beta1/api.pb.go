...
type ReleaseRequest struct {
	ContainerRequests []*ContainerReleaseRequest `protobuf:"bytes,1,rep,name=container_requests,json=containerRequests" json:"container_requests,omitempty"`
}

func (m *ReleaseRequest) Reset()                    { *m = ReleaseRequest{} }
func (*ReleaseRequest) ProtoMessage()               {}
func (*ReleaseRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{13} }

func (m *ReleaseRequest) GetContainerRequests() []*ContainerReleaseRequest {
	if m != nil {
		return m.ContainerRequests
	}
	return nil
...
func (m *ContainerReleaseRequest) Reset()                    { *m = ContainerReleaseRequest{} }
func (*ContainerReleaseRequest) ProtoMessage()               {}
func (*ContainerReleaseRequest) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{14} }

func (m *ContainerReleaseRequest) GetDevicesIDs() []string {
	if m != nil {
		return m.DevicesIDs
	}
	return nil
...
func (*ReleaseResponse) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{15} }
...
func init() {
	...
	proto.RegisterType((*ReleaseRequest)(nil), "v1beta1.ReleaseRequest")
	proto.RegisterType((*ContainerReleaseRequest)(nil), "v1beta1.ContainerReleaseRequest")
	proto.RegisterType((*ReleaseResponse)(nil), "v1beta1.ReleaseResponse")
}
...
func (c *devicePluginClient) Release(ctx context.Context, in *ReleaseRequest, opts ...grpc.CallOption) (*ReleaseResponse, error) {
	out := new(ReleaseResponse)
	err := grpc.Invoke(ctx, "/v1beta1.DevicePlugin/Release", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DevicePlugin_Release_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReleaseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DevicePluginServer).Release(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1beta1.DevicePlugin/Release",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DevicePluginServer).Release(ctx, req.(*ReleaseRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _DevicePlugin_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Release",
			Handler:    _DevicePlugin_Release_Handler,
		},
		{
...
func (m *ContainerReleaseRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ContainerReleaseRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *ContainerReleaseRequest) Size() (n int) {
	var l int
	_ = l
	if len(m.DevicesIDs) > 0 {
		for _, s := range m.DevicesIDs {
...
func (this *ReleaseRequest) String() string {
	...
	s := strings.Join([]string{`&ReleaseRequest{`,
		`ContainerRequests:` + strings.Replace(fmt.Sprintf("%v", this.ContainerRequests), "ContainerReleaseRequest", "ContainerReleaseRequest", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ContainerReleaseRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ContainerReleaseRequest{`,
		`DevicesIDs:` + fmt.Sprintf("%v", this.DevicesIDs) + `,`,
		`}`,
	}, "")
	return s
...
func (m *ReleaseRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.ContainerRequests = append(m.ContainerRequests, &ContainerReleaseRequest{})
			if err := m.ContainerRequests[len(m.ContainerRequests)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *ContainerReleaseRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ContainerReleaseRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ContainerReleaseRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorApi = []byte{
	...
	,
}
